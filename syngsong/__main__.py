...
if __name__ == '__main__':
    ...
    parser.add_argument("--acronyms", "-a", help="Create acronyms from the first letter in each word of each verse and couplet.", action='store_true')
    ...
    core.generate_passwords(args.artist, genius_key, args.mask, min_len=args.minsize, max_len=args.maxsize, top_songs=args.topsongs, acronyms=args.acronyms)
